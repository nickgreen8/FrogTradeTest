...
<style>
	...
	/** Custom styles */
	.frogPond .d { color: grey; background-color: #e6e6e6; }
</style>

<body class="frogPond">
	<h1>Original Pond</h1>
	<?php
		//Display origional pool
		$pond->display();
	?>
	...
	<?php
		...
		//Display pond without dead frogs
		$pond->display();
	?>

	<h1>Encourage Frogs to Mate</h1>
	<?php
		//Encourage Frogs to Mate
		$pond->matingSeason();
